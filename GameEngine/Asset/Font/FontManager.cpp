...
bool CFontManager::Init()
{
	...
	LoadFontCollection("MapleLight",
		TEXT("Maplestory-Light.ttf"), "EngineFont");

	LoadFont("MapleLight", GetFontFaceName("MapleLight"),
		600, 13.f, TEXT("ko"));

	LoadFontCollection("MapleBold",
		TEXT("Maplestory-Bold.ttf"), "EngineFont");

	LoadFont("MapleBold", GetFontFaceName("MapleBold"),
		600, 15.f, TEXT("ko"));

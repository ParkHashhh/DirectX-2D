...
bool CEndingWidget::Init()
{
	...
	OKButton->SetEventCallback<CEndingWidget>(
		EButtonEventState::Click, this, &CEndingWidget::OkClick);
	...
	CancleButton->SetEventCallback<CEndingWidget>(
		EButtonEventState::Click, this, &CEndingWidget::CancleClick);
...
void CEndingWidget::CancleClick()
{
